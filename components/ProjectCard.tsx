...
export default function ProjectCard({ number, title, description, image, link }: ProjectCardProps) {
  ...
  return (
    <Container
      ...
      className="relative block h-full w-full border border-gray-800 rounded-3xl overflow-hidden cursor-pointer group bg-[#111111]/80 backdrop-blur hover-lift expand-line"
