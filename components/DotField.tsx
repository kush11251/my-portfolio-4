...
const DotField = memo(({
  ...
  useEffect(() => {
    ...
    const ctx = canvasElement.getContext('2d', { alpha: true }) as CanvasRenderingContext2D;
    if (!ctx) return;
  ...
  return (
    <div className={styles.dotFieldContainer} {...rest}>
      <canvas ref={canvasRef} className={styles.dotFieldCanvas} />
      <svg className={styles.dotFieldSvg}>
        <defs>
