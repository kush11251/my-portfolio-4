...
const DEFAULT_INNER_GRADIENT = 'linear-gradient(145deg,#0f766e8c 0%,#22d3ee44 100%)';
...
const ProfileCardComponent = ({
  avatarUrl = 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=640&q=80',
  iconUrl,
  grainUrl,
  innerGradient,
  ...
  const handleDeviceOrientation = useCallback(
    (event: DeviceOrientationEvent) => {
      ...
      const y = clamp(
        centerY + (beta - 20) * mobileTiltSensitivity,
        0,
        shell.clientHeight
      );
